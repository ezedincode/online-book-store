...
<template>
    <div class="flex flex-col">
        ...
        <!-- Top action bar -->
        <div class="flex flex-col sm:flex-row justify-between px-4 sm:px-7 pt-4 sm:pt-8 pb-2 sm:pb-0 gap-3 sm:gap-0 items-center">
            <div @click="navigateHome" class="cursor-pointer self-start sm:self-auto sm:ml-5">
            ...
            <div class="flex w-full sm:w-auto"> 
                <input v-model="authStore.keyword" type="text" class="pl-4 sm:pl-10 flex-1 sm:w-[40vw] outline-none rounded-r-[0px] py-2 border rounded-[20px] bg-[#ededf0] text-sm" placeholder="Search Book">
                <select v-model="authStore.type" class="border text-white [&>*]:bg-white [&>*]:text-[#00008B] h-10 sm:h-12 rounded-lg pl-3 sm:pl-6 bg-[#00008B] rounded-l-[0px] text-xs sm:text-sm">
    ...
    <!-- Navigation bar -->
    <div class="bg-[#173f5f] mt-2 sm:mt-5 flex flex-wrap justify-center gap-3 sm:gap-6 md:gap-10 text-white items-center px-4 py-3 md:h-12">
  ...
  <div class="pt-[160px] sm:pt-[180px] md:pt-[140px] px-4 sm:px-6 md:px-12 flex flex-col gap-3 min-h-[400px]">
    <!-- Books List -->
